...
```{r, 'Loaded packages', message=FALSE, echo=FALSE}
library(papaja)
library(tinylabels)
library(ds4ling)
library(tidyverse)
...
```{r echo=FALSE, warning=FALSE, 'Dataset', message=FALSE}
...
```
  ...
  The following table summarizes the first six rows of our database. In order to do so, we used the functions "knitr::kable" and "head()" in R and included our dataset.

```{r, 'Dataset: Table', message=FALSE, echo=FALSE}

knitr::kable(head(my_data_tidy_proyecto))
...
```{r, 'Model: Natural Science', message=FALSE, echo=FALSE}
...
```{r, 'Check Model Diagnosis: Natural Science', message=FALSE, echo=FALSE}
...
```{r, 'Durbin-Watson Test: Natural Science', message=FALSE, echo=FALSE}
...
```{r,'Model: Social Sciences', message=FALSE, echo=FALSE}
...
```{r, 'Check Model Diagnosis: Social Science', message=FALSE, echo=FALSE}
plot(mod_int_c_soc)
```
...
```{r, 'Durbin-Watson Test: Social Science', message=FALSE, echo=FALSE}
...
```{r, 'Model: Physical Education', message=FALSE, echo=FALSE}
...
```{r, 'Check Model Diagnosis: Physical Education', message=FALSE, echo=FALSE}
plot(mod_int_ef_fi)
```
...
```{r, 'Durbin-Watson Test: Physical Education', message=FALSE, echo=FALSE}
...
```{r, 'Model: Spanish', message=FALSE, echo=FALSE}
...
```{r, 'Check Model Diagnosis: Spanish', message=FALSE, echo=FALSE}
...
```{r, 'Durbin-Watson Test: Spanish', message=FALSE, echo=FALSE}
...
```{r, 'Model: Catalan', message=FALSE, echo=FALSE}
...
```{r, 'Check Model Diagnosis: Catalan', message=FALSE, echo=FALSE}
...
```{r, 'Durbin-Watson Test: Catalan', message=FALSE, echo=FALSE}
...
```{r, 'Model: English', message=FALSE, echo=FALSE}
...
```{r, 'Check Model Diagnosis: English', message=FALSE, echo=FALSE}
plot(mod_int_leng_est)
```
 After performing a regression analysis, we checked if the model works well for the data at hand. The residuals vs. fitted plot shows red horizontal line at zero, with no patterns, which suggests that we can assume linear relationship between the predictors and the outcome variables. The scale-location shows a horizontal line with equally spread points, which indicates homoscedasticity. With respect the normal Q-Q plot, all the points fall approximately along the reference line. Therefore, we can assume normality. Finally, the residuals vs. leverage plot highlights the top 3 most extreme points (#5, #29 and #121).

```{r, 'Durbin-Watson Test: English', message=FALSE, echo=FALSE}
...
```{r, 'Model: Math', message=FALSE, echo=FALSE}
...
```{r, 'Check Model Diagnosis: Math', message=FALSE, echo=FALSE}
plot(mod_int_mat)
```
...
```{r, 'Durbin-Watson Test: Math', message=FALSE, echo=FALSE}
...
```{r, 'Model: Arts', message=FALSE, echo=FALSE}
...
```{r, 'Check Model Diagnosis: Arts', message=FALSE, echo=FALSE}
plot(mod_int_plast)
```
...
```{r, 'Durbin-Watson Test: Arts', message=FALSE, echo=FALSE}
...
```{r, 'Model: Technology', message=FALSE, echo=FALSE}
...
```{r, 'Check Model Diagnosis: Technology', message=FALSE, echo=FALSE}
plot(mod_int_tecn)
```
  After performing a regression analysis, we checked if the model works well for the data at hand. The residuals vs. fitted plot shows red horizontal line at zero, with no patterns, which suggests that we can assume linear relationship between the predictors and the outcome variables. The scale-location shows a horizontal line with equally spread points, which indicates homoscedasticity. With respect the normal Q-Q plot, all the points fall approximately along the reference line. Therefore, we can assume normality. Finally, the residuals vs. leverage plot highlights the top 3 most extreme points (#5, #20 and #31).

```{r, 'Durbin-Watson Test: Technology', message=FALSE, echo=FALSE}
...
![encuesta1](./images/encuesta_1.png)

![encuesta1](./images/encuesta_2.png)
